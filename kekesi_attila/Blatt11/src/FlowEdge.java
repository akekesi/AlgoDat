...
public class FlowEdge {
    ...
    public static void main(String[] args) {
        int v = 12; // from
        int w = 23; // to
        double capacity = 4.56;
        double flow = 1.3;
        double delta = 0.26;

        FlowEdge e1 = new FlowEdge(v, w, capacity);
        System.out.println("edge1(" + e1.hashCode() + "): " + e1);
        FlowEdge e2 = new FlowEdge(v, w, capacity, flow);
        System.out.println("edge2(" + e2.hashCode() + "): " + e2);
        FlowEdge e3 = new FlowEdge(e2);
        System.out.println("edge3(" + e3.hashCode() + "): " + e3);

        System.out.println();
        System.out.println("edge3.other(v): " + e3.other(v));
        System.out.println("edge3.other(w): " + e3.other(w));

        System.out.println();
        System.out.println("edge3.residualCapacity(w): " + e3.residualCapacityTo(v));
        System.out.println("edge3.residualCapacity(w): " + e3.residualCapacityTo(w));

        System.out.println();
        e3.addResidualFlowTo(w, delta);
        System.out.println("edge3.addResidualCapacity(w, 0.26):");
        System.out.println("edge3.residualCapacity(v): " + e3.residualCapacityTo(v));
        System.out.println("edge3.residualCapacity(w): " + e3.residualCapacityTo(w));
    }
}
