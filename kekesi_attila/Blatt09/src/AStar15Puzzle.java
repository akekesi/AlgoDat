...
public class AStar15Puzzle {
    ...
    public static PartialSolution solveByAStar(Board board) {
        // TODO 1.3 solveAStar
        PriorityQueue<PartialSolution> partialSolutions = new PriorityQueue<PartialSolution>();
        ...
        while (!partialSolution.isSolution()) {
            ...
            partialSolution = partialSolutions.poll();
        }
...
//        String filename = "samples/board-3x3-online.txt";
//        String filename = "samples/board-4x4-online.txt";
//        String filename = "samples/board-6x6-online.txt";
//        String filename = "samples/board-2x4-online.txt";
