...
public class Board {
    ...
    public int manhattan() {
        ...
        for (int y = 0; y < this.ny; y++) {
            for (int x = 0; x < this.nx; x++) {
                number = this.field[y][x] - 1;
                if (number > -1) {
                    numberPosY = number / this.nx;
                    numberPosX = number % this.nx;
                    manhattan += Math.abs(y - numberPosY) + Math.abs(x - numberPosX);
                }
            }
        }
        return manhattan;
    ...
    public static void main(String[] args) {
        String[] filenames = {
            "samples/board-manhattan0.txt",
            "samples/board-manhattan1.txt",
            "samples/board-manhattan2.txt"
        };
