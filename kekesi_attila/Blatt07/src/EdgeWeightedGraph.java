...
public class EdgeWeightedGraph {
    ...
    public static void main(String[] args) {
        ...
        EdgeWeightedGraph edgeWeightedGraphIn = new EdgeWeightedGraph(in);
        System.out.println(edgeWeightedGraphIn);

        double[][] coordSet = new double[][] {
                {0, 0},
                {0, 1},
                {1, 1},
                {1, 1.5},
        ...
        edgeWeightedGraphIn.setCoordinates(coordSet);
        double coordGet[][] = edgeWeightedGraphIn.getCoordinates();
        for (double[] row: coordGet) {
