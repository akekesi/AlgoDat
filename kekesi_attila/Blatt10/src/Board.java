...
/**
 * The Board class represents one particular situation in the Ricochet Robots game.
 * The only changing parts during the game are the robots, while
...
public class Board {
     ...
     * other object variable. The walls are class variables (static) and are
    ...
    /**
     * Check whether the way from a given position is (in principle) free
    ...
    public boolean equals(Object o) {
        ...
        Board board = (Board) o;
        if (board.robots.length != this.robots.length) {
            return false;
        }
        for (int i = 0; i < this.robots.length; i++) {
            if (!this.robots[i].equals(board.robots[i])) { // order is important
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        int hashCode = 0;
        for (int i = 0; i < this.robots.length; i++) {
            hashCode = 31 * hashCode + this.robots[i].hashCode();
        }
        return hashCode;
    }
    ...
    public static void main(String[] args) throws java.io.FileNotFoundException {
        ...
        System.out.println("hashCode: " + board.hashCode());
